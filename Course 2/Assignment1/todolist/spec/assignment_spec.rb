...
describe Assignment do
  ...
  context "rq04" do 
    ...
    context "rq04.1 Must retrieve paginated User results from DB" do
      ...
      it "should implement find_allusers that returns a collection of Users and honors offset and limit parameters" do
        lastTime = Time.now
        (0..20).each do |i|
    ...
    context "rq04.2 Must retrieve paginated TodoList results from DB" do
      ...
      it "should implement find_alllists that returns a collection of TodoLists and honors offset and limit parameters" do
        dateBase = Date.today
        dateTrack = dateBase
        (0..20).each do |i|
